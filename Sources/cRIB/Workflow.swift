...
open class Workflow<ActionableItemType> {
    ...
    public final func onStep<NextActionableItemType, NextValueType>(_ onStep: @escaping (ActionableItemType) -> AnyPublisher<(NextActionableItemType, NextValueType), Never>) -> Step<ActionableItemType, NextActionableItemType, NextValueType> {
    ...
    public final func subscribe(_ actionableItem: ActionableItemType) -> Set<AnyCancellable> {
        guard cancellables.count > 0 else {
...
open class Step<WorkflowActionableItemType, ActionableItemType, ValueType> {
    ...
    private var publisher: AnyPublisher<(ActionableItemType, ValueType), Never>

    fileprivate init(workflow: Workflow<WorkflowActionableItemType>, publisher: AnyPublisher<(ActionableItemType, ValueType), Never>) {
    ...
    /// - returns: The next step.
    public final func onStep<NextActionableItemType, NextValueType>(_ onStep: @escaping (ActionableItemType, ValueType) -> AnyPublisher<(NextActionableItemType, NextValueType), Never>) -> Step<WorkflowActionableItemType, NextActionableItemType, NextValueType> {
